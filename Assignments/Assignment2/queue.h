...
public:
    // Adding getter method for next
    QElement* getNext() const { return next; }

    // Adding getter method for data
...
public:
    ...
    // Adding public getter method for head
    QElement* getHead() const { return head; }
};
